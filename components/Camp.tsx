...
const CampSite = ({
	...
	return (
		...
		>
			<div className="flex h-full flex-col justify-between items-start p-6 lg:px-20 lg:py-10">
...
const Camp = () => {
	return (
		<section className="2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
			...
			<div className="rounded flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
