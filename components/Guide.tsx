		...
		<section className="flexCenter flex-col">
			<div className="padding-container max-container w-full pb-24">
				<Image
					...
					alt="camp"
				/>
				<p className="uppercase regular-18 -mt-1 text-green-50 mb-3">
					We are here for you
				</p>
			...
			<div className="flexCenter max-container relative w-full">
				<Image
					...
					width={1440}
					height={580}
					className="object-cover w-full object-center 2xl:rounded-5xl"
				/>
				<div className="absolute flex bg-white py-8 pl-5 pr-7 gap-3 rounded-3xl border shadow-md md:left-[5%] lg:top-20">
					...
					<div className="flexBetween flex-col">
						<div className="flex w-full flex-col">
							...
							<p className="mt-2 bold-20">Aguas Calientes</p>
						</div>
						...
						<div className="flex w-full flex-col">
							...
							<h4 className="mt-2 bold-20 whitespace-nowrap">
								Wonorejo Pasuruan
							</h4>
						</div>
					</div>
